...
begin
	...
	-- State Registers
	buffer_state_regs: process(i_clock, i_reset_n, i_reset)
	begin
		if (i_reset_n = '0') then
	...
	helper_regs: process(i_clock, i_reset_n, i_reset)
	begin
		if (i_reset_n = '0') then
	...
	-- State registers
	cmd_state_regs: process(i_clock, i_reset_n, i_reset)
	begin
		if (i_reset_n = '0') then
	...
	-- Local Registers
	local_regs: process(i_clock, i_reset_n, i_reset, current_cmd_state, card_connected, command_valid, i_avalon_writedata, command_completed, command_ready)
	begin
		if (i_reset_n = '0') then
	...
	argument_regs_processing: process(i_clock, i_reset_n, i_reset, current_cmd_state, i_avalon_writedata, command_ready)
	begin
		if (i_reset_n = '0') then
